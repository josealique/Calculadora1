...
public class Calculadora {
    ...
    public Calculadora() {
        ...
        /*
        Opcion para Polinomios, tira Error
         else if (Objects.equals(TipoOperacion.getSelectedItem().toString(), "Polinomial")){
                String[] s = Operaciones.getText().split(" ");
                for (int i = 0; i < s.length; i++) {
                    Polinomial p = new Polinomial(s[i]);
                    Polinomial p2 = new Polinomial(s[++i]);
                    Resultado.setText(p.add(p2).toString());
                }
         */
    ...
    /**
     * Método que muestra el Jframe de la Clase Calculadora
     */
    public void mostrar() {
