...
public class CambioUnidades extends JDialog {
    ...
    /**
     * @throws Exception: Puede lanzar una excepción, si el campo de números contiene letras, o está vacío
     * Método que se encarga de cambiar las unidades
     */
    private void cambiarUnidad() {
        String s  = Origen.getText();
        if (s.isEmpty()){
            ...
            JOptionPane.showMessageDialog(null, "El campo de unidades no puede contener letras", "Alerta", JOptionPane.WARNING_MESSAGE);
        }
    }
